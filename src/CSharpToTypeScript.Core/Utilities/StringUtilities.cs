...
public static class StringUtilities
{
    ...
    public static string ToCommaSeparatedList(this IEnumerable<string> texts)
        => string.Join(", ", texts);

    public static string ToSpaceSeparatedList(this IEnumerable<string> texts)
        => string.Join(" ", texts);
    ...
    public static string SquashWhiteSpace(this string text)
